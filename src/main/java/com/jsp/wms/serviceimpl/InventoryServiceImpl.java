...
public class InventoryServiceImpl implements InventoryService{
	...
	public ResponseEntity<ResponseStructure<InventoryResponse>> createInventory(InventoryRequest inventoryRequest , int storageId , int quantity
		...
		batch = batchRespository.save(batch);
	...
	@Override
	public ResponseEntity<ResponseStructure<InventoryResponse>> readInventory(int productId) {
	...
	public ResponseEntity<ResponseStructure<InventoryResponse>> updateInventory(InventoryRequest inventoryRequest,
		...
		return inventoryRepository.findById(productId).map(inventory -> {
			...
			Batch batch = batchRespository.findByInventory_ProductId(productId).orElseThrow(() -> new InventoryNotFoundByIdException("Stock not found"));
			...
			Inventory updatedInventory = inventoryMapper.mapToInventoryRequest(inventoryRequest, inventory);
...
//				}
	...
	public ResponseEntity<ResponseStructure<InventoryResponse>> updateInventory(int productId, int storageId, int quantity) {
		...
		List<Batch> batches = batchRespository.findByInventoryAndStorage(inventory, storage);
